...
// Only enabled in this repo's .oxlintrc.json (SecureReq's ESLint config was the only one enforcing method naming).
const PascalCaseMethodRule = {
  meta: RuleMeta('Require PascalCase for class method names'),
  create(Context) {
...
export default {
  ...
  rules: {
    ...
    'pascal-case-method': PascalCaseMethodRule,
